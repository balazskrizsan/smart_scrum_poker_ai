...
open class VectorDims : AbstractRoutine<Int>("vector_dims", Public.PUBLIC, SQLDataType.INTEGER) {
    companion object {
    ...
    init {
        returnParameter = VectorDims.RETURN_VALUE
        addInParameter(VectorDims._1)
    }

    /**
     * Set the <code>_1</code> parameter IN value to the routine
     */
    fun set__1(value: Any?): Unit = setValue(VectorDims._1, value)
