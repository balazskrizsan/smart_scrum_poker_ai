...
CREATE UNIQUE INDEX unique__vector_store_1536__question_id__vector_model_id
    ON vector_store_1536 (question_id, vector_model_id)
    WHERE jira_issue_id IS NULL;

CREATE UNIQUE INDEX unique__vector_store_1536__jira_issue_id__vector_model_id
    ON vector_store_1536 (jira_issue_id, vector_model_id)
...
CREATE UNIQUE INDEX unique__vector_store_3072__question_id__vector_model_id
    ON vector_store_3072 (question_id, vector_model_id)
    WHERE jira_issue_id IS NULL;

CREATE UNIQUE INDEX unique__vector_store_3072__jira_issue_id__vector_model_id
    ON vector_store_3072 (jira_issue_id, vector_model_id)
    WHERE question_id IS NULL;
